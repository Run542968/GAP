...
# CUDA_VISIBLE_DEVICES=7 python debug.py --cfg_path "./config/ActivityNet13_CLIP_zs_75.yaml" --batch_size 16 --target_type "prompt" --model_name "ActivityNet13_CLIP_prompt_zs_v6_1" --num_queries 5 --enc_layers 2 --dec_layers 2 --enable_backbone
